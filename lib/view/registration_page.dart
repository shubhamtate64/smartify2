                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(() => TextField(
                                  ...
                                  onChanged: (val) {
                                    registrationController.email.value =
                                        val.trim();
                                    registrationController.validateEmail(
                                        val); // Validate immediately
                                  },
                                  decoration: InputDecoration(
                            ...
                            Obx(() => TextField(
                                  ...
                                  onChanged: (val) {
                                    registrationController
                                        .confirmPassword.value = val.trim();
                                    registrationController
                            ...
                            Obx(() => TextField(
                                  controller:
                                      registrationController.mobileNoController,
                                  keyboardType: TextInputType.phone,
                                  onChanged: (val) {
                                    registrationController.mobileNo.value =
                                        val.trim();
                                    registrationController.validateMobileNo(
                                        val); // Validate immediately
                                  },
                                  style: const TextStyle(color: Colors.black),
                                  decoration: InputDecoration(
                                      ...
                                      child: DropdownButtonHideUnderline(
                                        child: DropdownButton<String>(
                                          ...
                                          onChanged: (value) {
                                            ...
                                            registrationController.validateGender(
                                                value); // Validate immediately
                                          },
                                        ),
                                      ),
                                    ),
                            ...
                            Obx(() {
                              return Text(
                                registrationController.genderError.value.isEmpty
                                    ? ''
                                    : registrationController.genderError.value,
                                style:
                            ...
                            Obx(() => TextField(
                                  controller:
                                      registrationController.passcodeController,
                                  keyboardType: TextInputType.phone,
                                  onChanged: (val) {
                                    registrationController.passcode.value =
                                        val.trim();
                                    registrationController.validepasscode(val);
